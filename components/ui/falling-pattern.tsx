...
export function FallingPattern({
	...
	const generateBackgroundImage = () => {
		const patterns = [
			...
			// Row 5
			`radial-gradient(2px 100px at 0px 204px, ${color}, transparent)`,
			`radial-gradient(2px 100px at 300px 204px, ${color}, transparent)`,
			`radial-gradient(1px 1px at 150px 102px, ${color} 100%, transparent 150%)`,
			// Row 6
			`radial-gradient(2px 100px at 0px 134px, ${color}, transparent)`,
			`radial-gradient(2px 100px at 300px 134px, ${color}, transparent)`,
			`radial-gradient(1px 1px at 150px 67px, ${color} 100%, transparent 150%)`,
			// Row 7
			`radial-gradient(2px 100px at 0px 179px, ${color}, transparent)`,
			`radial-gradient(2px 100px at 300px 179px, ${color}, transparent)`,
			`radial-gradient(1px 1px at 150px 89.5px, ${color} 100%, transparent 150%)`,
			// Row 8
			`radial-gradient(2px 100px at 0px 299px, ${color}, transparent)`,
			`radial-gradient(2px 100px at 300px 299px, ${color}, transparent)`,
			`radial-gradient(1px 1px at 150px 149.5px, ${color} 100%, transparent 150%)`,
			// Row 9
			`radial-gradient(2px 100px at 0px 215px, ${color}, transparent)`,
			`radial-gradient(2px 100px at 300px 215px, ${color}, transparent)`,
			`radial-gradient(1px 1px at 150px 107.5px, ${color} 100%, transparent 150%)`,
			// Row 10
			`radial-gradient(2px 100px at 0px 281px, ${color}, transparent)`,
			`radial-gradient(2px 100px at 300px 281px, ${color}, transparent)`,
			`radial-gradient(1px 1px at 150px 140.5px, ${color} 100%, transparent 150%)`,
			// Row 11
			`radial-gradient(2px 100px at 0px 158px, ${color}, transparent)`,
			`radial-gradient(2px 100px at 300px 158px, ${color}, transparent)`,
			`radial-gradient(1px 1px at 150px 79px, ${color} 100%, transparent 150%)`,
			// Row 12
			`radial-gradient(2px 100px at 0px 210px, ${color}, transparent)`,
			`radial-gradient(2px 100px at 300px 210px, ${color}, transparent)`,
